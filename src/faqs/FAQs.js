          ...
          <div>
            <div className={ham ? "home-right1" : "home-right"}>
              ...
              <div className="right-block-container">
                <div className="right-block1">
                  <div className="right-block1-part1-container">
                    <p style={{ fontSize: "18px" }}>FAQs</p>
                    <Accordion style={{ background:'#f3f4f6' }}>
                      <AccordionSummary
                      ...
                      <AccordionDetails style={{background:'#fff'}}>
                        <div>
                          <div style={{fontSize:'14px'}}>
                            <p>
                              No, Affiliate Indians has a strict No Refund
                              Policy. Members are not allowed under any
                              circumstances to issue refunds as all Affiliate
                              Indians members are given instant access to the
                              members area and this access cannot be taken back.
                            </p>
                          </div>
                        </div>
                      </AccordionDetails>
